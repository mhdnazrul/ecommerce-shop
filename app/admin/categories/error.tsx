...
export default function AdminCategoriesError({
  ...
  useEffect(() => {
    logger.error('Admin categories error boundary caught error', {}, error)
  }, [error])
  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center p-4">
      <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border border-gray-100">
        ...
        <p className="text-gray-500 mb-8 font-medium">Something went wrong loading this admin page. Please try again.</p>
